...
// на місце видалених елементів дозволяє вставити нові
...
// Task-1
// Напиши скрипт який буде перебирати масив та видаляти
// з нього(мутувати) всі елементи що не є типом даних Number.
...
// Функція повина відібрати з масиву тільки ті елементи 
// що дублюються в ньому та повернути їх в вигляді нового масиву як результат виконання функції
...
// Напиши скрипт, який змінить порядок літер у рядку 
//(зворотний порядок літер, тобто розверне рядок) і виведе його в консоль.
...
// Task-5
// Напиши скрипт який буде перевіряти чи елементи 
//в масиві розташовані в порядку зростання,
...
// використовуємо цикл в циклі для того 
// //щоб numbers[i] елемент порівняти зі всіма попередніми(всіма перед ним)
