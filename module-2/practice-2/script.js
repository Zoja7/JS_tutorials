...
// const robotAnswer = robot(false);
// console.log(robotAnswer)

//* Example 5
// Приклад - Impure function (брудна функція)
//- змінює вхідні дані в процесі виконання
...
//------
// Приклад - Pure function (чиста функція) -
//не змінює вхідні дані,
//а на їхній основі просто видає новий результат
//(правильний підхід до написання функцій)
...
//* Task-1;
// Створи функцію яка буде перевіряти
//чи кожен елемент масиву більше ніж вказане значення.
...
//на потрібну кількість елементів
//розділяючи на декілька масивів.
