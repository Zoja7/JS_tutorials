...
//  Функція приймає 1 параметр 
// //  це об'єкт користувачів
...
// /** define users by their`s names and 
// common title of books */
...
// //   return `Average reader age is:
// //    ${Math.floor(totalAge / usersWithAge.length)}`;
// // }
